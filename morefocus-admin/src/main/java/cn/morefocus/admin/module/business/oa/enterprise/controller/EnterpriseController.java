...
public class EnterpriseController {
    ...
    @Operation(summary = "分页查询企业模块 @author loki")
    ...
    @Operation(summary = "导出企业信息 @author loki")
    ...
    public void exportExcel(@RequestBody @Valid EnterpriseQueryForm queryForm, HttpServletResponse response) throws IOException {
        ...
        if (CollectionUtils.isEmpty(data)) {
            LocalResponseUtil.write(response, R.userErrorParam("暂无数据"));
            return;
        }

        // 设置下载消息头
        LocalResponseUtil.setDownloadFileHeader(response, "企业基本信息.xls", null);
    ...
    @Operation(summary = "查询企业详情 @author loki")
    ...
    @Operation(summary = "新建企业 @author loki")
    ...
    @Operation(summary = "编辑企业 @author loki")
    ...
    @Operation(summary = "删除企业 @author loki")
    ...
    @Operation(summary = "按照类型查询企业 @author loki")
    ...
    @Operation(summary = "企业添加员工 @author loki")
    ...
    @Operation(summary = "查询企业全部员工 @author loki")
    ...
    @Operation(summary = "分页查询企业员工 @author loki")
    ...
    @Operation(summary = "企业删除员工 @author loki")
