...
public class AdminDictController extends SupportBaseController {
    ...
    @Operation(summary = "分页查询数据字典KEY - @author loki")
    ...
    @Operation(summary = "数据字典KEY-添加- @author loki")
    ...
    @Operation(summary = "数据字典缓存-刷新- @author loki")
    ...
    @Operation(summary = "数据字典Value-添加- @author loki")
    ...
    @Operation(summary = "数据字典KEY-更新- @author loki")
    ...
    @Operation(summary = "数据字典Value-更新- @author loki")
    ...
    @Operation(summary = "数据字典KEY-删除- @author loki")
    ...
    @Operation(summary = "数据字典Value-删除- @author loki")
