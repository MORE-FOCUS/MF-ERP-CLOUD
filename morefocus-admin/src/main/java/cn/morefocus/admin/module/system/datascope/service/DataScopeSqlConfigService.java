...
import cn.morefocus.admin.AdminApplication;
import cn.morefocus.admin.module.system.datascope.DataScope;
...
public class DataScopeSqlConfigService {
    ...
    private static final String DEPARTMENT_PARAM = "#deptIds";
