...
public class RoleEmployeeController {
    ...
    @Operation(summary = "查询某个角色下的员工列表  @author loki")
    ...
    @Operation(summary = "获取某个角色下的所有员工列表(无分页)  @author loki")
    ...
    @Operation(summary = "从角色成员列表中移除员工 @author loki")
    ...
    @Operation(summary = "从角色成员列表中批量移除员工 @author loki")
    ...
    @Operation(summary = "角色成员列表中批量添加员工 @author loki")
    ...
    @Operation(summary = "获取员工所有选中的角色和所有角色 @author loki")
