...
(
    ...
    `is_disabled` tinyint unsigned NOT NULL COMMENT '是否被禁用 0否1是',
...
(
    ...
    `is_disabled` tinyint(1) NOT NULL DEFAULT '0' COMMENT '禁用状态',
    `sort_value`                 int                                                                    DEFAULT '0' COMMENT '排序',
    `remark`                     varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci          DEFAULT NULL COMMENT '备注',
    `update_time`                datetime                                                      NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `update_by`                  bigint                                                                 DEFAULT NULL COMMENT '更新人ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='公用服务 - 服务心跳';
