...
CREATE TABLE `t_erp_bill_detail_file` (
  ...
  `dept_id` bigint DEFAULT NULL COMMENT '部门ID',
  `bill_id` int DEFAULT NULL COMMENT '单据ID',
  `bill_detail_id` int DEFAULT NULL COMMENT '单据名称ID',
...
CREATE TABLE `t_erp_initial_stock` (
  ...
  `spu_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'spu编号',
  `quantity` decimal(10,2) DEFAULT NULL COMMENT '数量',
  `price` decimal(10,2) DEFAULT NULL COMMENT '单价',
  `sku_id` int DEFAULT NULL COMMENT 'skuid',
  `sku_no` int DEFAULT NULL COMMENT 'skuno',
  `unit_id` int DEFAULT NULL COMMENT '单位ID',
  `sku_stock_id` int DEFAULT NULL COMMENT '库存ID',
  `sku_stock_detail_id` int DEFAULT NULL COMMENT '库存明细ID',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `t_erp_sku_file` (
  ...
  `dept_id` bigint DEFAULT NULL COMMENT '部门ID',
  `sku_id` int DEFAULT NULL COMMENT 'skuid',
  `sku_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'sku编号',
  `file_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件路径',
...
CREATE TABLE `t_erp_spu_file` (
  ...
  `dept_id` bigint DEFAULT NULL COMMENT '部门ID',
  `spu_id` int DEFAULT NULL COMMENT 'spuid',
  `spu_no` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'spu编号',
  `file_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件路径',
  `is_main` bit(1) DEFAULT b'0' COMMENT '是否主图',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `idx_spu_id` (`spu_id`) USING BTREE COMMENT 'spuid'
...
-- ----------------------------
-- Table structure for t_erp_store
-- ----------------------------
DROP TABLE IF EXISTS `t_erp_store`;
CREATE TABLE `t_erp_store` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `sort_value` int DEFAULT '0' COMMENT '排序',
  `remark` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  `create_by_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人名称',
  `dept_id` bigint DEFAULT NULL COMMENT '部门ID',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '门店名称',
  `code` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '门店编号',
  ...
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '门店地址',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for t_erp_warehouse
-- ----------------------------
...
CREATE TABLE `t_erp_warehouse` (
  ...
  `category_id` int DEFAULT NULL COMMENT '仓库类目ID',
...
-- ----------------------------
-- Table structure for t_erp_warehouse_category
-- ----------------------------
DROP TABLE IF EXISTS `t_erp_warehouse_category`;
CREATE TABLE `t_erp_warehouse_category` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `sort_value` int DEFAULT '0' COMMENT '排序',
  `remark` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户登录日志';
...
CREATE TABLE `t_tenant` (
  ...
  `package_id` int DEFAULT NULL COMMENT '当前套餐ID',
  PRIMARY KEY (`id`) USING BTREE
