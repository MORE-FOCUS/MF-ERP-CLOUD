...
public class SmartOperationCustomizer implements OperationCustomizer {
    ...
    public Operation customize(Operation operation, HandlerMethod handlerMethod) {
        ...
        if (!encryptBuilderList.isEmpty()) {
            noteList.add("<br/><font style=\"color:red\" class=\"light-red\">接口安全：" + LocalStringUtils.join(",", encryptBuilderList) + "</font>");
        }
        ...
        // 更新
        operation.setDescription(LocalStringUtils.join("<br/>", noteList));
