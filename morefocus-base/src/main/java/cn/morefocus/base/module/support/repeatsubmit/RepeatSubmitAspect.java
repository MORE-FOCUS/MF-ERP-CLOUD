package cn.morefocus.base.module.support.repeatsubmit;
...
import cn.morefocus.base.module.support.repeatsubmit.ticket.AbstractRepeatSubmitTicket;
...
public class RepeatSubmitAspect {
     ...
     * @throws Throwable
     */
    @Around("@annotation(cn.morefocus.base.module.support.repeatsubmit.annoation.RepeatSubmit)")
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (lastRequestTime != null) {
            ...
            if (System.currentTimeMillis() < lastRequestTime + interval) {
                // 提交频繁
                return R.error(UserErrorCode.REPEAT_SUBMIT);
            }
        }
        Object obj;
        try {
