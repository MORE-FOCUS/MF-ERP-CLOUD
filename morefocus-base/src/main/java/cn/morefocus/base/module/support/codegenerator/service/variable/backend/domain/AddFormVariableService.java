...
import cn.morefocus.base.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (LocalStringUtils.isNotEmpty(codeField.getEnumName())) {
                ...
                packageList.add("import cn.morefocus.common.common.validator.enumeration.CheckEnum;");
            ...
            //字典
            if (LocalStringUtils.isNotEmpty(codeField.getDict())) {
            ...
            //文件上传
            if (LocalStringUtils.contains(field.getFrontComponent(), "Upload")) {
