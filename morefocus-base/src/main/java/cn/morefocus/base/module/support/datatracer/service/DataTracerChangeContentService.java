...
public class DataTracerChangeContentService {
    ...
    private DataTracerContentBO getFieldValue(Field field, Object object) {
        ...
        if (dataTracerFieldEnum != null) {
            if (fieldValue instanceof Collection) {
                fieldContent = LocalEnumUtil.getEnumDescByValueList((Collection) fieldValue, dataTracerFieldEnum.enumClass());
            } else {
                fieldContent = LocalEnumUtil.getEnumDescByValue(fieldValue, dataTracerFieldEnum.enumClass());
            }
            ...
            if (dataTracerFieldBigDecimal != null) {
                BigDecimal value = LocalBigDecimalUtil.setScale((BigDecimal) fieldValue, dataTracerFieldBigDecimal.scale());
    ...
    private String getRelateDisplayValue(Object fieldValue, DataTracerFieldSql dataTracerFieldSql) {
        ...
        return LocalStringUtils.join(",", displayValue);
    }
